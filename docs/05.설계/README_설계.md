...
| `05-20` | `05-20_PDF_암호화_및_상황별_보안전략_엔진_상세설계서.md` | PDF 암호화 및 상황별 보안전략 엔진 상세설계서 | ISO 32000-1 표준 암호화(RC4/AES-128/AES-256), 전략/팩토리/빌더/파사드 패턴, 8대 권한 비트마스크 및 상황별 보안 프로필 관리 |
| `05-21` | `05-21_서비스_자가진단_및_화면기능_검증_자동화_거버넌스_설계서.md` | 서비스 자가진단 및 화면·기능 검증 자동화 거버넌스 설계서 | 5단계 서비스 전수점검, 백엔드 테스트케이스 & 프론트 화면테스트 사전 기준 설계, 토큰절약형 API 자가진단 |
| `05-22` | `05-22_PDF_보안_및_메타데이터_설정_모달_연동_설계서.md` | PDF 보안 및 메타데이터 설정 모달 및 뷰어 내보내기 연동 설계서 | 메타데이터+보안 통합 설정 모달, 브라우저 PDF 내보내기 파이프라인 및 원격 브랜치 실시간 크로스체크 API 연동 |
