...
<div align="center">
  <img src="./images/03-14_모바일반응형_카드전환_및_가로스크롤_원천방지_디자인가이드_diag_2.svg" alt="03-14. 모바일 반응형 카드 전환 및 가로스크롤 원천 방지 디자인 가이드 - 아키텍처 및 상태 흐름도 다이어그램 2" style="max-width: 100%; height: auto; border: 1px solid #334155; border-radius: 12px;" />
  <p><em>[그림] 03-14. 모바일 반응형 카드 전환 및 가로스크롤 원천 방지 디자인 가이드 - 아키텍처 및 상태 흐름도 다이어그램 2</em></p>
</div>
