...
<div align="center">
  <img src="./images/260921_014_세션격리_및_DB영속화_보안보완_승급_리뷰_diag_1.svg" alt="10-14. 세션격리 및 DB영속화, P0 보안보완 승급 리뷰 - 아키텍처 및 상태 흐름도 다이어그램 1" style="max-width: 100%; height: auto; border: 1px solid #334155; border-radius: 12px;" />
  <p><em>[그림] 10-14. 세션격리 및 DB영속화, P0 보안보완 승급 리뷰 - 아키텍처 및 상태 흐름도 다이어그램 1</em></p>
</div>
