...
<div align="center">
  <img src="./images/06-01_01_mobile_ui_objects.svg" alt="모바일 반응형 5대 표준 오브젝트 상호작용 체계" style="max-width: 100%; height: auto; border: 1px solid #334155; border-radius: 12px;" />
  <p><em>[그림] 모바일 반응형 5대 표준 오브젝트 상호작용 체계</em></p>
</div>
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2026-09-21 | #01 | TASK-001 | gemini | [v1.0] 최초 제정: 모바일 8대 뷰 사용자 여정, 5대 표준 오브젝트 UI 명세서 및 인터랙션 시나리오 | Gemini 2.5 Flash | Google AI Studio | [03-01. 문서 정책](../03.정책/03-01_문서작성_및_편집이력_정책.md) |
