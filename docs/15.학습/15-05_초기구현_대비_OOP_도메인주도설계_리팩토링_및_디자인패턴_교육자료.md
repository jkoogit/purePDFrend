...
<div align="center">
  <img src="./images/15-05_초기구현_대비_OOP_도메인주도설계_리팩토링_및_디자인패턴_교육자료_diag_1.svg" alt="15-05. 초기 구현 대비 OOP/도메인 주도 설계(DDD) 리팩토링 및 디자인 패턴 교육 가이드 - 아키텍처 및 상태 흐름도 다이어그램 1" style="max-width: 100%; height: auto; border: 1px solid #334155; border-radius: 12px;" />
  <p><em>[그림] 15-05. 초기 구현 대비 OOP/도메인 주도 설계(DDD) 리팩토링 및 디자인 패턴 교육 가이드 - 아키텍처 및 상태 흐름도 다이어그램 1</em></p>
</div>
