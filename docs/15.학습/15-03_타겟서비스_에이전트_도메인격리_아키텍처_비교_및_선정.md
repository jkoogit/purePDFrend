...
<div align="center">
  <img src="./images/15-03_타겟서비스_에이전트_도메인격리_아키텍처_비교_및_선정_diag_1.svg" alt="15-03. 타겟 서비스(ppdf)와 에이전트 서비스(aiagent) 도메인 격리 아키텍처 비교 및 선정 - 아키텍처 및 상태 흐름도 다이어그램 1" style="max-width: 100%; height: auto; border: 1px solid #334155; border-radius: 12px;" />
  <p><em>[그림] 15-03. 타겟 서비스(ppdf)와 에이전트 서비스(aiagent) 도메인 격리 아키텍처 비교 및 선정 - 아키텍처 및 상태 흐름도 다이어그램 1</em></p>
</div>
