...
export const SESSION_012_TURNS: ConversationTurnRecord[] = [
  {
...
export async function syncConversationTurns(turns: ConversationTurnRecord[] = [...SESSION_003_TURNS, ...SESSION_012_TURNS]) {
