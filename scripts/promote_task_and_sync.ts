/**
 * @file scripts/promote_task_and_sync.ts
 * @description TASK-260924-0012-01 태스크 상태를 '완료'로 최종 승급하고 local_agent_store.json 및 DB 반영
 */
...
async function main() {
  console.log('=== [Harness] TASK-260924-0012-01 태스크 상태 \'완료\' 승급 시작 ===');
  ...
  const taskId = 'TASK-260924-0012-01';
