import {
  insertLookDefs
} from "./chunk-MVGRGQ7G.js";
import {
  insertEdge,
  insertEdgeLabel,
  markers_default,
  positionEdgeLabel
} from "./chunk-U6WEYEDD.js";
import {
  insertCluster
} from "./chunk-THVLP2Z5.js";
import {
  insertNode
} from "./chunk-GS7HCSUP.js";
import {
  labelHelper
} from "./chunk-TU37VO3I.js";
import {
  interpolateToCurve
...
// node_modules/mermaid/dist/chunks/mermaid.core/chunk-GNY47TPC.mjs
var internalHelpers = {
...
var elkLayoutLoaders = __name(() => {
  const loader = __name(async () => await import("./elk-276RUBZZ-KV43PQXV.js"), "loader");
  return [
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-6A5THRUB-LE34PEKY.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-2SLR337P-QIAAKNFO.js"), "loader")
    },
    ...
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-SO75YVAB.js"), "loader")
      },
      ...elkLayoutLoaders()
    ] : []
  ]);
...
//# sourceMappingURL=chunk-HK2C4AER.js.map
