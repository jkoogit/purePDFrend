...
// node_modules/mermaid/dist/chunks/mermaid.core/stateDiagram-v2-GCMORJYK.mjs
var parser = (function() {
...
var colorSlotFor = __name((shape, itemId, parent, userStyled) => {
  if (shape === SHAPE_DIVIDER && (parent == null ? void 0 : parent.id) !== void 0 && containerColorIndex.has(parent.id)) {
...
var StateDB = (_a = class {
  ...
  getData() {
    ...
    const config = getConfig2();
    for (const node of this.nodes) {
      node.wrappingWidth ?? (node.wrappingWidth = (_a2 = config.state) == null ? void 0 : _a2.wrappingWidth);
      if (!node.isGroup) {
        node.minWidth ?? (node.minWidth = (_b = config.state) == null ? void 0 : _b.minNodeWidth);
      }
    }
    return {
      nodes: this.nodes,
...
//# sourceMappingURL=stateDiagram-v2-GCMORJYK-YFGWFPDP.js.map
